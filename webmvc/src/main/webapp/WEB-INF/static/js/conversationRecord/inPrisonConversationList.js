 var PAGESIZE = 10;
        ...
        function jumpOnEditPage(id){
        	if(!!id){
        		window.location.href=urlRootContext+"/conversationRecord/editInPrisonConversationList/"+id;	
        	}        	
        }
        ...
        function buildTable(userName,pageNumber,pageSize) {
        	 var url =  urlRootContext + "/conversationRecord/findInPrisonConversationList"; //请求的网址
