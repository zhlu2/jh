 var PAGESIZE = 10;
        ...
        function jumpOnEditPage(id){
        	if(!!id){
        		window.location.href=urlRootContext+"/conversationRecord/editOutPrisonConversationList/"+id;	
        	}        	
        }
        ...
        function buildTable(userName,pageNumber,pageSize) {
        	 var url =  urlRootContext + "/conversationRecord/findOutPrisonConversationList"; //请求的网址
