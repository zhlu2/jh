...
<script src="<%=request.getContextPath()%>/static/js/user/userList.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/demoController/index">用户基本信息</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>用户基本信息表</div>
