...
<%-- <script src="<%=request.getContextPath()%>/static/js/jQuery/jquery.js"></script> --%>
<script
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="#" id="aco-police-form" class="horizontal-form">
											...
											<h3 class="form-section">戒毒人员信息新增页面</h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-fullname"
																class="m-wrap span12" placeholder="请输入姓名"> <span
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-personid"
																class="m-wrap span12" placeholder="请输入人员编号"> <span
																class="help-block"></span>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-certificatenum"
																class="m-wrap span12" placeholder="请输入证件号码">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-casehandleperson"
																class="m-wrap span12" placeholder="请输入办案人员"> <span
																class="help-block"></span>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-abandonmethod"
																class="m-wrap span12" placeholder="请输入戒毒方法"> <span
																class="help-block"></span>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-abandonstartdate"
																class="m-wrap span12" placeholder="请输入戒毒开始日期"> <span
																class="help-block"></span>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<input type="text" id="aco-entryreason"
																class="m-wrap span12" placeholder="请输入入所原因"> <span
																class="help-block"></span>
