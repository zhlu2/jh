...
<script
	src="<%=request.getContextPath()%>/static/js/dedrugdetainedInfo/infoList.js"></script>
<link
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a
								href="${pageContext.request.contextPath }/dedrugBasicInfo/infoList">入所信息维护</a></li>
