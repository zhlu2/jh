...
<script src="<%=request.getContextPath()%>/static/js/juryRegis/juryRegisList.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/juryRegis/list">伤情登记</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>伤情登记表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">										
										 ...
										 <a class="btn green"  href="<%=request.getContextPath()%>/juryRegis/addpage">
								...
								<table class="table table-striped table-bordered table-hover" id="tableResult">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">受伤情况</th>

											<th class="hidden-480">病史情况</th>

											<th class="hidden-480">登记人</th>
											
											<th class="hidden-480">送押民警</th>
