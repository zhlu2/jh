...
<body>
            <div class="actions">
                <div class="btn-group">
                    <a class="btn btn-default btn-sm"
                     href="<%=request.getContextPath()%>/juryRegis/addpage"
                    >
	...
	<script type='text/javascript'>    
        ...
        function jumpOnEditPage(id){
        	if(!!id){
        		window.location.href=urlRootContext+"/juryRegis/editPage/"+id;	
        	}        	
        }
        ...
        function buildTable(userName,pageNumber,pageSize) {
        	 var url =  urlRootContext + "/juryRegis/findJuryRegisList"; //请求的网址
         ...
         if (dataList.length > 0 ) {
             $(dataList).each(function(){//重新生成
                    ...
                    $("#tableBody").append('<td>' + this.injurysitu + '</td>');
                    $("#tableBody").append('<td>' + this.medicalhistorysitu + '</td>');
                    $("#tableBody").append('<td>' + this.detainedpolice + '</td>');
                    $("#tableBody").append('<td>' + this.scpolice + '</td>');
