...
<script
	src="<%=request.getContextPath()%>/static/js/conversationRecord/conversationRecordList.js"></script>
<link
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">谈话教育</h3>

						<ul class="breadcrumb">

							<li><a href="${pageContext.request.contextPath }/user/index">主界面</a>

								<i class="icon-angle-right"></i></li>

							<li><a
								href="${pageContext.request.contextPath }/conversationRecord/list">谈话教育</a></li>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a class="btn green"
											href="<%=request.getContextPath()%>/conversationRecord/addpage">
