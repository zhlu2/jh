...
<script src="<%=request.getContextPath()%>/static/js/conversationRecord/conversationRecordList.js"></script>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">										
										 ...
										 <a class="btn green"  href="<%=request.getContextPath()%>/conversationRecord/addpage">
