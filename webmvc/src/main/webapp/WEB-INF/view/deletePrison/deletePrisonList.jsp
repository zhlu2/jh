...
<script src="<%=request.getContextPath()%>/static/js/deletePrison/deletePrisonList.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/dedrugBasicInfo/deletePrisonList">误删除恢复</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>误删除恢复表</div>
