...
<script src="<%=request.getContextPath()%>/static/js/prsArrgInfo/prsArrgInfoList.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/prsArrgInfo/list">临时探访</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>临时探访表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">										
										 ...
										 <a class="btn green"  href="<%=request.getContextPath()%>/prsArrgInfo/addpage">
								...
								<table class="table table-striped table-bordered table-hover" id="tableResult">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">申请民警</th>

											<th class="hidden-480">探访人姓名</th>
											
											<th class="hidden-480">性别</th>

											<th class="hidden-480">年龄</th>

                                            <th class="hidden-480">与被探访人关系</th>
                                            
                                            <th class="hidden-480">申请理由</th>
