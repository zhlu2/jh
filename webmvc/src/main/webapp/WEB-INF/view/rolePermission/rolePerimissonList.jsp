				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/rolePermission/list">角色基本信息</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>角色基本信息表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">										
										 ...
										 <a class="btn green"  href="<%=request.getContextPath()%>/role/addPage">
