	...
	<div class="actions">
		<div class="btn-group">
			<a class="btn btn-default btn-sm"
				href="<%=request.getContextPath()%>/role/addPage">
				<input type="hidden" id="aco-user-id" value="${id}"> <i
										...
										$(dataList)
												.each(
														function() {//重新生成
															...
															$("#tableBody")
																	.append(
																			"<a href=\"javascript:void(0);\" id=\"aco-user-role-deleteBtn"
																					+ this.roleId
																					+ "\" onclick=\"deleEvent('"
																					+ this.roleId
																					+ "')\" class=\"btn default btn-xs red-stripe\">删除</a>");
															$("#tableBody")
																	.append(
																			'</tr>');
														});
