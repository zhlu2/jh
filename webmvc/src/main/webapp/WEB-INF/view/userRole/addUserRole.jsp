...
<script src="<%=request.getContextPath()%>/static/js/userRole/addUserRole.js"></script>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="${pageContext.request.contextPath }/user/index">用户权限管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="#">用户角色操作页面</a></li>
