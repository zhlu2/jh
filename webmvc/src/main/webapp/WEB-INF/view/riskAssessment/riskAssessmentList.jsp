...
<script src="<%=request.getContextPath()%>/static/js/riskAssessment/riskAssessmentList.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="${pageContext.request.contextPath }/riskAssessment/list">风险评估申请</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>风险评估申请表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">										
										 ...
										 <a class="btn green"  href="<%=request.getContextPath()%>/riskAssessment/addpage">
